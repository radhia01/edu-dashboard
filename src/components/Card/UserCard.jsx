...
function UserCard({user}) {
    ...
    <div className="row-span-3 flex flex-col justify-center items-center text-gray-800 p-1">
      <div className=""> <img className='rounded-full h-[100px] w-[100px]' src={user.image}/></div>  
      <div className=" text-center text-xl mt-1 text-gray-800">  <h1 >{user.FirstName} {user.LastName}</h1></div>
    ...
    <div className="row-span-1  flex justify-center"> <button className='rounded-full w-full  bg-gray-600'>Read More</button></div>
        </div>)
}
